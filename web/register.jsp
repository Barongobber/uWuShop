                                    ...
                                    <div class="card-body">
                                        <form method="post" action="UserController">
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" name="username" id="username" required type="text" placeholder="Enter  username" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="email" id="email" type="email" required placeholder="Enter email address" />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="address">Address</label>
                                                        <input class="form-control py-4" name="address" id="address" type="text"  placeholder="Enter address" required/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="phonenum">Phone Number</label>
                                                        <input class="form-control py-4" name="phonenum" id="phonenum" type="text" placeHolder="Enter phone Number" required=""/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
