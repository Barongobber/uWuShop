...
<html lang="en">
    <head>
        ...
        <title>Admin Login - UwuShop</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="AdminController">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="adminname" name="adminname" type="text" placeholder="Enter adminname" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <input type="hidden" name="control" value="loginAdmin"/> 
