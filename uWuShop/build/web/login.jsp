...
<html lang="en">
    <head>
        ...
        <title>Login Page - UwuShop</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="UserController">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="username" name="username" type="text" placeholder="Enter username address" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <input type="hidden" name="control" value="loginUser"/> 
